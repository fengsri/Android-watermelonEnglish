...
public class PracticeFragment3 extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view=LayoutInflater.from(container.getContext()).inflate(R.layout.practice_fragment3,container,false);
        //初始化
        init(view);
        return view;
    }
    ...
    private void init(View view) {
        recyclerView=view.findViewById(R.id.ct_recyclerview);
        //设置适配器
