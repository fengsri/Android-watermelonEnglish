...
public class PracticeRecyclerviewAdapter extends RecyclerView.Adapter<PracticeRecyclerviewAdapter.ViewHolder> {
    private List<Pract> practList;
    private Context context;

    public PracticeRecyclerviewAdapter(List<Pract> practList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.practice_recyclerview_item,parent,false);
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            imageView=itemView.findViewById(R.id.practice_item_image);
            textView=itemView.findViewById(R.id.practice_item_title);
