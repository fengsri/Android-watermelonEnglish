...
public class PracticeFragment2 extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view=LayoutInflater.from(container.getContext()).inflate(R.layout.practice_fragment2,container,false);
        //初始化
        init(view);
        return view;
    }
    ...
    private void init(View view) {
        recyclerView=view.findViewById(R.id.ss_recyclerview);
        //设置适配器
