...
public class PracticeFragment4 extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view=LayoutInflater.from(container.getContext()).inflate(R.layout.practice_fragment4,container,false);
    ...
    private void init(View view) {
        recyclerView=view.findViewById(R.id.reader_recyclerview);
        //设置适配器
